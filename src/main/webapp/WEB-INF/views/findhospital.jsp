...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=4f2e00432226d31fffa7266c8bf8f06e&libraries=services"></script>
<script src="https://code.jquery.com/jquery-1.11.3.js"></script> 
<script>
document.addEventListener("DOMContentLoaded", function() {
   // function getLocation(position) {

        var latitud = '37.554106';
        var longitude = '126.935683';
